...
console.log("The first string has a length of " + lengthOne);
console.log("The second string has a length of " + lengthTwo);
console.log("The third string has a length of " + lengthThree);
